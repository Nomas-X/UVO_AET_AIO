...
missionNamespace setVariable ["AET_isDone_CBA_Settings", false, false];
["CBA_settingsInitialized", { // from postInit
	missionNamespace setVariable ["AET_isDone_CBA_Settings", true, false];
},[_unit]] call CBA_fnc_addEventHandler;
